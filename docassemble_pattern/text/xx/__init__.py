...
# Base classes for the parser, verb table and sentiment lexicon are inherited from docassemble_pattern.text.
...
from docassemble_pattern.text.xx.inflect import (
...
from docassemble_pattern.text.xx import inflect
